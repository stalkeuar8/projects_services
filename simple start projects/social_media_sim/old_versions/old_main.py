...
print("Program 'Social media simulator' started!")
                                    ...
                                    match gl_choice:
                                        ...
                                        case 4:
                                            ...
                                            while True:
                                                ...
                                                if choice.lower() == 'yes':
                                                    # all_user_logs = main.json_loader('user_logs.json')
                                                    # for user_logs in all_user_logs.keys():
                                                    #     del all_user_logs[user_logs]
                                                    # main.update_json('user_logs.json', all_user_logs)
                                            ...
                                            if user_to_ban in all_user_info_dict.keys():
                                                ...
                                                while True:
                                                    ...
                                                    if ban_choice.lower() == 'yes':
                                                        # all_user_info_dict[user_to_ban]["is_banned"] = True
                                                        # all_user_info_dict[user_to_ban]["posts"] = []
                                                        # general_info = main.json_loader('general_info.json')
                                                        # general_info['post_qty'] -= all_user_info_dict[user_to_ban]['user_post_qty']
                                                        # main.update_json('general_info.json', general_info)
                                                        # all_user_info_dict[user_to_ban]['user_post_qty'] = 0
                                                        # main.update_json('user_info.json', all_user_info_dict)
                                        ...
                                        case 8:
                                            ...
                                            if user_to_unban in all_user_info_dict.keys():
                                                # all_user_info_dict[user_to_unban]["is_banned"] = False
                                                # main.update_json('user_info.json', all_user_info_dict)
...
#     print("Program 'Social media simulator' started!")
#     print("\nPlease, log in!\n")
#     us_nick = input("Enter your login: ")
#     us_info_dict = main.json_loader('user_info.json')
#     if main.is_registered(us_info_dict, us_nick):
#         for attempt in range(1, 4):
#             us_pass = input("Enter your password: ")
#             if main.pass_checker(us_info_dict, us_nick, us_pass):
...
#                         case 1:
#                             text = input("Enter what do you want to post: ")
#                             main.current_user.create_post(text)
#                             continue
#                         case 2:
#                             print(main.current_user.show_posts())
#                             continue
#                         case 3:
#                             num_id = input("Enter post id to find: ")
#                             id_to_find = 'Id: ' + num_id
#                             print(main.current_user.find_post_by_id(id_to_find))
#                             continue
#                         case 4:
#                             num_id = input("Enter post id to delete: ")
#                             id_to_delete = 'Id: ' + num_id
...
#                                 temp_choice = input("Enter Yes or No: ")
#                                 if temp_choice.lower() == 'yes':
#                                     print(main.current_user.delete_my_post_by_id(id_to_delete))
#                                     break
#                                 elif temp_choice.lower() == 'no':
#                                     print("Deleting canceled!")
#                                     break
#                                 else:
#                                     print("Wrong choice! Please try more")
#                                     continue
#                             continue
#                         case 5:
#                             print("Are you sure you want to delete all your posts?")
...
#                                 if choice.lower() == 'yes':
#                                     print("\nYour posts are deleted!\n")
#                                     print(main.current_user.delete_all_my_posts())
#                                     break
#                                 elif choice.lower() == 'no':
#                                     print("\nDeleting canceled! ")
#                                     break
...
#                 break
#             else:
#                 print("Invalid pass! Try more! You have 2 tries!") if not 3-attempt == 1 else print("Invalid pass! Try more! You have 1 try!")
#                 if attempt == 3:
#                     print("You have no more attempts! Try later.")
#                     break
#     else:
